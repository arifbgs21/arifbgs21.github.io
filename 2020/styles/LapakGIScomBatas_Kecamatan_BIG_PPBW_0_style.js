...
var style_LapakGIScomBatas_Kecamatan_BIG_PPBW_0 = function(feature, resolution){
    ...
    if (value > 0.000000 && value <= 0.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 0.000000 && value <= 2853.400000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 2853.400000 && value <= 3885.800000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 3885.800000 && value <= 4444.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 4444.000000 && value <= 5256.000000) {
            style = [ new ol.style.Style({
